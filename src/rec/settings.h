...
#define ANALOG_MAX_RATE             "360000"
#define ANALOG_BUF_SIZE             "1300000"

#define DIGITAL_MAX_CAMS            4
#define DIGITAL_RTSP_URL            "rtsp://1.1.1.%d:554/s0" // TODO:: expose port and rtsp path to config file.
...
#define DIGITAL_HTTP_API_SCREESHOTS "/usr/bin/wget -q -O %s/%s.000000.I%d.jpg \'http://1.1.1.%d/snap.jpeg'"
...
#define DEFAULT_alert_type         "horn"
...
#define DEFAULT_psi_high_threshold  "100"
